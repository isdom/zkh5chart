/*******************************************************************************
 * File: h5-chart-zoom-circular.js 
	...
	this.drawLabels = function(canvasId, arrLabel, only) {
		...
		for ( var n = 0; n < arrLabel.length; n++) {
			...
			if ((only != null && only == n) || only == null) {
				...
				drawText(canvasId, 5, y, labl, 0, this.labels.valueStyle.color,
						this.labels.valueStyle.font, "left");

				drawText(canvasId, 5, y + fs, this.labels.valueStyle.mask(val),
						0, this.labels.valueStyle.color,
						this.labels.valueStyle.font, "left");
