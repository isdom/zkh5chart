...
h5chart.Circle = zk.$extends(zk.Widget, {
	_shadow: 'false',
	_radius: 0,
	...
	setPlot: function(value){
		...
		var w=Math.max(parseInt(this.getRadius())*2,parseInt(this.getWidth()));
		var h=Math.max(parseInt(this.getRadius())*2,parseInt(this.getHeight()));
		...
		var t=new Circle();
		t.left=left+this.getBorderWidth()+(this.getRadius());
