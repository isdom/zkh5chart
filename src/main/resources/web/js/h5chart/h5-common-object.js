...
function Shape(){
	...
	this.borderStyle='solid'; 		// solid; dotted, dashed;
	this.fillStyle='none'; 			// none, solid, h-linear,  v-linear, h-cilinder, v-cilinder , linear, cilinder
	this.color=0;					// Start fill color
	this.endColor='#fff';
	this.shadow;					// Shadow Object to apply
...
function Text(){
	...
	this.align='center'; //'start, end, left, right, center'
...
//Tick Mode='max','min','med'
//Tick Orientation 'over','center','under'
//rule Orientation 'vertical','horizontal'
...
function Grid(x,y,w,h,intervalsX,intervalsY,type,axes){
	...
	this.type=type; // 'rect' 'radial'
	this.axes=axes; //'v-grid', 'h-grid', 'both'
